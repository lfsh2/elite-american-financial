    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Manage your Elite Financial phone numbers</p>
        </div>
        <button 
      ...
      {activeTab === 'porting' && (
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-500 mb-6">You haven't submitted any requests to port existing phone numbers to Elite Financial.</p>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 text-left">
              ...
              <p className="text-blue-600 text-sm mb-4">
                Transfer your existing phone numbers from another provider to Elite Financial.
              </p>
